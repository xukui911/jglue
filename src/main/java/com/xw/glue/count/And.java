...
public class And extends Value<Boolean> implements Count<BoolValue>{
	private Value<?> value;
	private Value<?> value2;
	private boolean isDouble;
	
	public And(Value<?> value, Value<?> value2) {
		this(value, value2, false);
	}
	
	public And(Value<?> value, Value<?> value2, boolean isDouble) {
		this.value = value;
		this.value2 = value2;
